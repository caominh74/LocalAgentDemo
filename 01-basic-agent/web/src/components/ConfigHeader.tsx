...
import { Settings2, Terminal, AlertTriangle } from 'lucide-react';
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-sm font-bold tracking-tight text-white">Demo 1: The Naive Agent</h1>
              <span className="rounded bg-slate-800 px-1.5 py-0.5 text-[10px] font-mono text-slate-400 border border-slate-700">Port 5173</span>
              <span className="rounded bg-amber-950/60 border border-amber-800/60 px-2 py-0.5 text-[11px] font-semibold text-amber-400 flex items-center gap-1">
                <AlertTriangle className="h-3 w-3" /> Unvalidated / Naive
              </span>
            </div>
            <p className="text-[11px] text-slate-500">Direct JSON.parse · Blind Tool Dispatch · Exposes Local LLM Failure Modes</p>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-slate-800 bg-slate-950 p-4 grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full rounded bg-slate-900 border border-slate-700 px-2.5 py-1.5 text-slate-200 focus:outline-none focus:border-amber-500 font-mono text-xs"
